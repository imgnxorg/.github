...
`Advanced`
> ### $179 per month
> An SST app *($26)* with a single OAuth provider *($100)*, all legal documents *($26)*, data and storage backups *($20 + $3 = $23)*, and WAF protection *($4)*.

`Expert`
> ### $429 per month
> An SST app *($26)* with a "Magic Link" provider *($50)*, an Internal OAuth provider *($200)*, all legal documents *($26)*, data and storage backups *($20 + $3 = $23)*, WAF protection *($4)*, 2 integrations, and a monthly Risk Assessment *($50 × 2 = $100)*.
